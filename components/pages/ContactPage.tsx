...
const contactMethods = [
  ...
  },
  {
    name: 'LinkedIn',
    icon: <FaLinkedin />,
    url: 'https://linkedin.com/manakhare',
    text: 'https://linkedin.com/manakhare'
  },
  {
    name: 'GitHub',
    icon: <FaGithub />,
  ...
  },
  {
    name: 'LeetCode',
    icon: <SiLeetcode />,
    url: 'https://leetcode.com/manakhare',
    ...
    <div className="w-full h-full flex flex-col items-center p-8">
        <div className='w-3/4'>
            <AnimatePresence>
                ...
                className="text-4xl font-bold text-amber-900 mb-8 flex justify-center items-center font-serif border-b-4 border-amber-900"
                >
                Contact Me
                </motion.h2>
            </AnimatePresence>
        ...
        >
            <div className='w-3/4 grid grid-cols-2 gap-8'>
                {contactMethods.map((method, index) => (
                    ...
                    className="flex flex-col items-center p-6 bg-amber-50 rounded-lg shadow-md hover:shadow-lg transition-all cursor-pointer"
                    >
