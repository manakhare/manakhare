  ...
  return (
    <div className="relative h-screen w-full bg-rustic-brown">
      <motion.nav
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="fixed hidden top-4 left-1/2 -translate-x-1/2 bg-black/20 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg lg:flex gap-8 text-aged-paper"
      >
        <button 
      ...
      <div className="w-[100%] bg-[url(/cover3.jpg)] bg-no-repeat bg-center bg-cover bg-opacity-50 lg:w-[50%] h-[100%] flex flex-col items-center justify-center">
        <motion.img
          src="/Mana.png"
          alt="Profile"
        ...
        />
        <motion.h1
          className="text-4xl lg:text-5xl font-bold mb-4 text-amber-200"
        ...
        <motion.p
          className="text-lg lg:text-xl text-amber-200 mb-12"
          initial={{ y: 20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
        >
